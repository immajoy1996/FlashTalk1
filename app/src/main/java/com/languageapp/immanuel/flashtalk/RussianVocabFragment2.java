...
public class RussianVocabFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        translit.add("see-vod-nya");translit.add("dyen");translit.add("pag-o-da");translit.add("k-nee-ga"); translit.add("zda-nye");
        translit.add("myes-ta");translit.add("dom");translit.add("ma-shee-na");
