...
public class RussianImFromAmericaFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_im_from_america_fragment1, container, false);
        ...
        String str="из (eez) means \"from\". Anything after из takes the genitive case. It's easy. Keep in mind the \"Shush GoalKeeper\" Rule.";
        String keyword1="из (eez)";
        String keyword2="из takes";
        String keyword3="eez";
        ...
        spannableString.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.medium_sea_green)), str.indexOf(keyword2), str.indexOf(keyword2)+2, 0);

        spannableString.setSpan(new StyleSpan(Typeface.BOLD), str.indexOf(keyword1), str.indexOf(keyword1)+2, 0);
        spannableString.setSpan(new StyleSpan(Typeface.BOLD), str.indexOf(keyword2), str.indexOf(keyword2)+2, 0);
        spannableString.setSpan(new StyleSpan(Typeface.ITALIC), str.indexOf(keyword3), str.indexOf(keyword3)+keyword3.length(), 0);
        intro_textview.setText(spannableString);

        TextView example1_textview=rootView.findViewById(R.id.example1);
        String str1="Я из Америки.";
        ...
        final Uri uri1=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/amer1"); // header1
        final Uri uri2=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/amer2");
        final Uri uri3=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/amer3");
