...
public class RussianImWatchingTVFragment4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_im_watching_tvfragment4, container, false);
        ...
        games.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               /* mediaPlayer.stop();
                ...
                intent.putExtra("LESSON_NAME","I'm Watching A Movie");
                //pause.setVisibility(View.GONE);
                //volume.setVisibility(View.VISIBLE);
