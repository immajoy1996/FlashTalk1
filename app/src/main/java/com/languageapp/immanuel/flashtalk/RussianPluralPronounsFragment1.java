...
public class RussianPluralPronounsFragment1 extends Fragment {
    ...
    public RussianPluralPronounsFragment1() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_plural_pronouns_fragment1, container, false);
        //Toolbar toolbar = (Toolbar)rootView.findViewById(R.id.toolbar_fragment1);
        //toolbar.setTitle("Plural Pronouns");

        SharedPreferences mPrefs=getContext().getSharedPreferences("Hints",0);
        String str0=mPrefs.getString("var_PluralPronouns","not shown");
        ...
        if(str0.equals("not shown")) {
            ...
            mEditor.putString("var_PluralPronouns","shown");
            mEditor.commit();
        }

        final Uri uri1=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/basic_plurals_fragment1_word1");
        final Uri uri2=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/basic_plurals_fragment1_word2");
        final Uri uri3=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/basic_plurals_fragment1_word3");
        final Uri uri4=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/basic_plurals_fragment1_word4");
        final Uri uri5=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/basic_plurals_fragment1_word5");
        final Uri uri6=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/basic_plurals_fragment1_word6");
        final Uri uri7=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/basic_plurals_fragment1_word7");
        ...
        final ViewPager viewPager=getActivity().findViewById(R.id.plural_pronouns_pager);
        //final int MAX=mediaPlayer.getDuration() / STEP_TIME;

        //final Uri uri=Uri.parse("android.resource://"+rootView.getContext().getPackageName()+"/raw/basic_plurals_fragment1_word1");
    ...
    public void onPause() {
        ...
        /*mediaPlayer.stop();
        mediaPlayer.release();
        Uri uri=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/basic_plurals_fragment1_word1");
        mediaPlayer=MediaPlayer.create(getContext(),uri);*/
