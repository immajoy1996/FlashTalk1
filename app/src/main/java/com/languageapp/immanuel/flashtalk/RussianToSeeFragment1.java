...
public class RussianToSeeFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_to_see_fragment1, container, false);
        ...
        final ViewPager viewPager=getActivity().findViewById(R.id.tosee_pager);

        TextView textView_intro=rootView.findViewById(R.id.intro);
        String intro_str="Verbs ending in -еть are conjugated the same way as verbs ending in -ить.";
        String keyword1="-еть";
        String keyword2="-ить";
        ...
        spannableString1.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.medium_sea_green)),intro_str.indexOf(keyword2),intro_str.indexOf(keyword2)+keyword2.length(),0);
        spannableString1.setSpan(new StyleSpan(Typeface.BOLD),intro_str.indexOf(keyword2),intro_str.indexOf(keyword2)+keyword2.length(),0);
        ...
        final Uri uri1=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/vid1"); // header1
        final Uri uri2=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/vid2");
        final Uri uri3=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/vid3");
        final Uri uri4=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/vid4");
        final Uri uri5=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/vid5"); // header2
        final Uri uri6=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/vid6");
        final Uri uri7=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/vid7");
