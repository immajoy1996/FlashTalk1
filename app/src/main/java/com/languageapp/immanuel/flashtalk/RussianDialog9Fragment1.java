...
public class RussianDialog9Fragment1 extends Fragment {
    ...
    public RussianDialog9Fragment1() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_dialog9_fragment1, container, false);
        //android.support.v7.widget.Toolbar Toolbar=rootView.findViewById(R.id.toolbar);
        //Toolbar.setTitle("Basic Verbs")

        ImageButton back_button=(ImageButton)rootView.findViewById(R.id.back_button);
        ImageButton forward_button=(ImageButton)rootView.findViewById(R.id.forward_button);
        final ViewPager viewPager=getActivity().findViewById(R.id.dialog9_pager);
        ...
        String str1="АЛЁНА : Привет, Себастьян!";
        String trans1="Hi, Sebastian!";
        //String str1_keyword1="новый";
        //String trans1_keyword1="new";
        String str1_name="АЛЁНА :";
        ...
        String str2="СЕБАСТЬЯН : Привет, Алёна.";
        String trans2="Hi Alyona.";
        String str2_name="СЕБАСТЬЯН :";
        ...
        String str3="АЛЁНА : Что ты делаешь сейчас? Ты читаешь роман?";
        String trans3="What are you doing now? Are you reading a novel?";
        String str3_name="АЛЁНА :";
        ...
        String str4="СЕБАСТЬЯН : Нет, конечно нет! Книги очень скучные.";
        String trans4="No, of course not! Books are very boring.";
        //String str4_keyword1="правда";
        //String trans4_keyword1="true";
        String str4_name="СЕБАСТЬЯН :";
        ...
        String str5="АЛЁНА : Ты изучаешь новый язык на Флештоке?";
        String trans5="Are you studying a new language on FlashTalk?";
        //String str5_keyword1="скучный";
        //String trans5_keyword1="boring";
        String str5_name="АЛЁНА :";
        ...
        String str6="СЕБАСТЬЯН : Нет, это очень трудно.";
        String trans6="No, that's very hard.";
        String str6_name="СЕБАСТЬЯН :";
        String str6_keyword1="трудно";
        String trans6_keyword1="hard";
        ...
        String str7="АЛЁНА : Хмм . . . Ты хочешь идти в фитнес-центр сейчас?";
        String trans7="Hmm . . . Do you want to go to the fitness-center now?";
        String str7_name="АЛЁНА :";
        ...
        String str8="СЕБАСТЬЯН : Нет, это не очень интересно.";
        String trans8="No, that's not very interesting.";
        String str8_name="СЕБАСТЬЯН :";
        ...
        String str9="АЛЁНА : Тогда . . . что ты делаешь каждый день, Себастьян?";
        String trans9="Then . . . what do you do every day, Sebastian?";
        String str9_name="АЛЁНА :";
        ...
        String str10="СЕБАСТЬЯН : О, я просто смотрю телевизор в моей комнате каждый день.";
        String trans10="Oh, I just watch television in my room every day.";
        String str10_name="СЕБАСТЬЯН :";
        ...
        String str11="АЛЁНА : Себастьян, это неинтересно! Ты очень скучный человек.";
        String trans11="Sebastian, that's not interesting! You're a very boring person.";
        String str11_name="АЛЁНА :";
        //String str11_keyword1="неинтересно";
        //String trans11_keyword1="not interesting";
