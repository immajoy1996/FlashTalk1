...
public class RussianToSeeFragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_to_see_fragment3, container, false);
        ...
        String str_intro="мужчина is masc. but acts like it's fem. Look at the first example.";
        String intro_keyword1="мужчина";
        ...
        spannableString_intro.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.transliteration_color)), str_intro.indexOf("masc."), str_intro.indexOf("masc.")+5, 0);
        spannableString_intro.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.red)), str_intro.indexOf("fem."), str_intro.indexOf("fem.")+4, 0);
        intro.setText(spannableString_intro);

        TextView textView1=rootView.findViewById(R.id.sentence1);
        String str1="Я вижу мужчину.";
        String keyword1="у.";
        SpannableString spannableString1=new SpannableString(str1);
        spannableString1.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.transliteration_color)),str1.indexOf(keyword1),str1.indexOf(keyword1)+1,0);
        textView1.setText(spannableString1);

        TextView textView3=rootView.findViewById(R.id.sentence3);
        String str3="Где ты? Мы не видим тебя.";
        String keyword3="тебя";
        ...
        games.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("LESSON_NAME","I See");
                //pause.setVisibility(View.GONE);
                //volume.setVisibility(View.VISIBLE);
