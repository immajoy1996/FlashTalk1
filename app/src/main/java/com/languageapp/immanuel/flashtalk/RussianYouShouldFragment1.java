...
public class RussianYouShouldFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_you_should_fragment1, container, false);
        //android.support.v7.widget.Toolbar Toolbar=rootView.findViewById(R.id.toolbar);
        //Toolbar.setTitle("Basic Verbs");

        ImageButton back_button=(ImageButton)rootView.findViewById(R.id.back_button);
        ImageButton forward_button=(ImageButton)rootView.findViewById(R.id.forward_button);
        final ViewPager viewPager=getActivity().findViewById(R.id.youshould_pager);
        ...
        String str="должен means \"should\". It's conjugated in a strange way but it only depends on whether the subject is masc., fem., neut. or pl. Get the pattern?";

        SpannableStringBuilder ssBuilder = new SpannableStringBuilder(str);
        String keyword0="должен";
        ...
        ssBuilder.setSpan(getResources().getColor(R.color.medium_sea_green),str.indexOf(keyword0),str.indexOf(keyword0)+keyword0.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        ...
        final Uri uri0=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/youshould1_sent1");
        final Uri uri1=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/youshould1_sent1"); // header1
        final Uri uri2=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/youshould1_sent2");
        final Uri uri3=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/youshould1_sent3");
        final Uri uri4=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/youshould1_sent4");
