...
public class RecyclerViewAdapterArabicAlphabet extends RecyclerView.Adapter<RecyclerViewAdapterArabicAlphabet.ViewHolder> {
    ...
    RecyclerViewAdapterArabicAlphabet(Context context, List<String> data1 ,List<SpannableString> data2) {
        cont=context;
        ...
        letter_files.put("ا","android.resource://"+context.getPackageName()+"/raw/letter1");
        letter_files.put("ب","android.resource://"+context.getPackageName()+"/raw/letter2");
        letter_files.put("ت","android.resource://"+context.getPackageName()+"/raw/letter3");
        letter_files.put("ث","android.resource://"+context.getPackageName()+"/raw/letter4");
        letter_files.put("ج","android.resource://"+context.getPackageName()+"/raw/letter5");
        letter_files.put("ح","android.resource://"+context.getPackageName()+"/raw/letter6");
        letter_files.put("خ","android.resource://"+context.getPackageName()+"/raw/letter7");
        letter_files.put("د","android.resource://"+context.getPackageName()+"/raw/letter8");
        letter_files.put("ذ","android.resource://"+context.getPackageName()+"/raw/letter9");
        letter_files.put("ر","android.resource://"+context.getPackageName()+"/raw/letter10");
        letter_files.put("ز","android.resource://"+context.getPackageName()+"/raw/letter11");
        letter_files.put("س","android.resource://"+context.getPackageName()+"/raw/letter12");
        letter_files.put("ش","android.resource://"+context.getPackageName()+"/raw/letter14");
        letter_files.put("ص","android.resource://"+context.getPackageName()+"/raw/letter14");
        letter_files.put("ض","android.resource://"+context.getPackageName()+"/raw/letter15");
        letter_files.put("ط","android.resource://"+context.getPackageName()+"/raw/letter16");
        letter_files.put("ظ","android.resource://"+context.getPackageName()+"/raw/letter17");
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.arabic_alphabet_rowview, parent, false);
        ...
        ViewHolder(final View itemView) {
            ...
            itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    SpannableString msg1 = new SpannableString("The letter \"a\" either stands alone or connects with the previous letter. It never connects with the next letter. Click the examples.");
                    //SpannableString msg2=new SpannableString("Click the buttons for audio.");
                    //(new MyApplication(cont)).show_hints(((FragmentActivity)cont).getSupportFragmentManager(), msg1, "var_Alphabet");
                    LettersDialogClass letter_dialog1=LettersDialogClass.newInstance(msg1);
                    letter_dialog1.show(((FragmentActivity)cont).getSupportFragmentManager(),"Letter1");
                    return false;
                }
            });
