...
public class RussianTheFutureFragment2 extends Fragment {
    ...
    public RussianTheFutureFragment2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_the_future_fragment2, container, false);
        ...
        final Uri uri1=Uri.parse("android.resource://"+getActivity().getPackageName()+"/raw/tomm1");
        final Uri uri2=Uri.parse("android.resource://"+getActivity().getPackageName()+"/raw/tomm2");
        final Uri uri3=Uri.parse("android.resource://"+getActivity().getPackageName()+"/raw/tomimp3");
        ...
        String str="Let's put the future tense to use! Notice that the same pattern works for any verb.";
        ...
        String str1="Завтра я буду делать моё задание. ";
        ...
        String str2="Ты будешь читать книгу завтра?";
        ...
        String str3="Я работаю сейчас. Потом, я буду есть.";
