...
public class RussianIHaveFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_ihave_fragment1, container, false);
        ...
        final Uri uri1=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/yest1");
        final Uri uri2=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/yest2");
        final Uri uri3=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/yest3");
        ...
        String str="To say \"there is\"/\"there exists\" in Russian, use the particle есть (yest). It's the same as the verb for \"to eat\". That's it!";

        SpannableString spannableString=new SpannableString(str);
        spannableString.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.medium_sea_green)), str.indexOf("есть"), str.indexOf("есть")+4, 0);
        spannableString.setSpan(new StyleSpan(Typeface.BOLD), str.indexOf("есть"), str.indexOf("есть")+4, 0);
        intro_textview.setText(spannableString);

        TextView example1_textview=rootView.findViewById(R.id.example1);
        String str1="Есть туалет здесь?";
        ...
        String str3="Есть красивый парк там.";
