...
public class RussianCountriesAndPeopleFragment1 extends Fragment {
    ...
    public RussianCountriesAndPeopleFragment1() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_countries_and_people_fragment1, container, false);
        //android.support.v7.widget.Toolbar Toolbar=rootView.findViewById(R.id.toolbar);
        //Toolbar.setTitle("Basic Verbs");

        SharedPreferences mPrefs=getContext().getSharedPreferences("Hints",0);
        String str0=mPrefs.getString("var_CountriesAndPeople","not shown");
        ...
        if(str0.equals("not shown")) {
            ...
            mEditor.putString("var_CountriesAndPeople","shown");
            mEditor.commit();
        }
        ...
        String str="Here are some useful countries.";
        ...
        String str1="Russia - Россия (ra-see-ya)";
        String keyword1="Россия (ra-see-ya)";
        String a1="Россия";
        String a2="ra-see-ya";
        ...
        String str2="America - Америка (a-mye-ree-ka)";
        String keyword2="Америка (a-mye-ree-ka)";
        String b1="Америка";
        String b2="a-mye-ree-ka";
        ...
        String str3="France - Франция (fran-tsee-ya)";
        String keyword3="Франция (fran-tsee-ya)";
        String c1="Франция";
        String c2="fran-tsee-ya";
