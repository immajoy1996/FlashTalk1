...
public class RussianPluralPronounsFragment3 extends Fragment {
    ...
    public RussianPluralPronounsFragment3() {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (this.isVisible()) {
            ...
            if (!isVisibleToUser) {
                /*mediaPlayer.stop();
                mediaPlayer.release();
                Uri uri=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/wethey_fragment3_sentence1");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_plural_pronouns_fragment3, container, false);
        //Toolbar toolbar = (Toolbar)rootView.findViewById(R.id.toolbar_fragment3);
        //toolbar.setTitle("Examples");

        final Uri uri1=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/wethey_fragment3_sentence1");
        final Uri uri2=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/wethey_fragment3_sentence2");
        final Uri uri3=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/wethey_fragment3_sentence3");
        ...
        //final Uri uri=Uri.parse("android.resource://"+rootView.getContext().getPackageName()+"/raw/wethey_fragment3_sentence1");
        ...
        games.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("LESSON_NAME","We, They");
                //pause.setVisibility(View.GONE);
                //volume.setVisibility(View.VISIBLE);
