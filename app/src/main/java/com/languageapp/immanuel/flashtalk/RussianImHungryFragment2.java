...
public class RussianImHungryFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_im_hungry_fragment2, container, false);
        ...
        String str1="Сегодня, ты должен изучать русский.";
        ...
        String str2="Я тоже должна делать это.";
        String keyword2="должна";
        ...
        String str3="Вы должны идти в университет.";
        String keyword3="должны";
        ...
        games.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("LESSON_NAME","I'm Hungry");
                //pause.setVisibility(View.GONE);
                //volume.setVisibility(View.VISIBLE);
        ...
        final Uri uri1=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/imhungry_ex1"); // header1
        final Uri uri2=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/imhungry_ex2");
        final Uri uri3=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/imhungry_ex3");
