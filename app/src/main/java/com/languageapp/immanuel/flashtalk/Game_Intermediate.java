...
public class Game_Intermediate extends Game_Generic{
    public Game_Intermediate(){
        TOTAL=5;
        ...
        Answer1.add("Hello. How are you? Hello. How are you? Hello. How are you? Hello. How are you?");
        Answer2.add("Bye Bye");
