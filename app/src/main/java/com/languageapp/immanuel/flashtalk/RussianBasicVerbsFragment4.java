...
public class RussianBasicVerbsFragment4 extends Fragment {
    ...
    public RussianBasicVerbsFragment4() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_basic_verbs_fragment4, container, false);
        //Toolbar toolbar = (Toolbar)rootView.findViewById(R.id.toolbar_fragment4);
        //toolbar.setTitle("говорить");
        ...
        String intro="по (pa) is used before a language name. In this context, it means \"in\". Notice that русский changes to русски after по.";
        String intro_keyword0="по (pa)";
        String intro_keyword1="по (";
        String intro_keyword2="по";
        String intro_keyword3_temp="русски after";
        String intro_keyword3_actual="русски";
        String intro_keyword4="по.";
        String intro_keyword5="русский";

        SpannableString spannableString_intro=new SpannableString(intro);
        spannableString_intro.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.medium_sea_green)), intro.indexOf(intro_keyword0), intro.indexOf(intro_keyword0)+intro_keyword0.length(), 0);
        ...
        spannableString_intro.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.medium_sea_green)), intro.indexOf(intro_keyword4), intro.indexOf(intro_keyword4)+2, 0);
        spannableString_intro.setSpan(new StyleSpan(Typeface.BOLD), intro.indexOf(intro_keyword4), intro.indexOf(intro_keyword4)+2, 0);

        spannableString_intro.setSpan(new StyleSpan(Typeface.BOLD), intro.indexOf(intro_keyword1), intro.indexOf(intro_keyword1)+2, 0);
        spannableString_intro.setSpan(new StyleSpan(Typeface.ITALIC), intro.indexOf("pa"), intro.indexOf("pa")+2, 0);
        ...
        spannableString_intro.setSpan(new StyleSpan(Typeface.BOLD), intro.indexOf(intro_keyword3_temp), intro.indexOf(intro_keyword3_temp)+intro_keyword3_actual.length(), 0);
        spannableString_intro.setSpan(new StyleSpan(Typeface.BOLD), intro.indexOf(intro_keyword5), intro.indexOf(intro_keyword5)+intro_keyword5.length(), 0);
        ...
        final ViewPager viewPager=getActivity().findViewById(R.id.basic_verbs_pager);
