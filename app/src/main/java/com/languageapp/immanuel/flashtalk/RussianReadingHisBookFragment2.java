...
public class RussianReadingHisBookFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final Uri uri1=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/pasporta1");
        final Uri uri2=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/pasport2");
        final Uri uri3=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/pasport3");
