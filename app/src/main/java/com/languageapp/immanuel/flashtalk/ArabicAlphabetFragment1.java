...
public class ArabicAlphabetFragment1 extends Fragment {

    //MediaPlayer mediaPlayer=null;

    //MediaPlayer mediaPlayer_alphabet;
    int STEP_TIME=100;
    RecyclerViewAdapterArabicAlphabet adapter;
    ...
    public ArabicAlphabetFragment1() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_arabic_alphabet_fragment1, container, false);
        ...
        lett.add("ا");lett.add("ب");lett.add("ت");lett.add("ث");lett.add("ج");lett.add("ح");
        lett.add("خ");lett.add("د");lett.add("ذ");lett.add("ر");lett.add("ز");lett.add("س");
        lett.add("ش");lett.add("ص");lett.add("ض");lett.add("ط");lett.add("ظ");lett.add("г");
        lett.add("з");
        ...
        adapter = new RecyclerViewAdapterArabicAlphabet(getContext(), lett,traslit);
