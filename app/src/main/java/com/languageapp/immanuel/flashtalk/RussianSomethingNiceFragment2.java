...
public class RussianSomethingNiceFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        spannableString1.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.medium_sea_green)),str1.indexOf(str1_keyword2),str1.indexOf(str1_keyword2)+str1_keyword2.length(),0);
