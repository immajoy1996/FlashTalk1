...
public class RussianINeedFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_ineed_fragment1, container, false);
        ...
        String str="нужен means \"it's necessary\". It's conjugated just like должен. In Russian, we don't say \"I need ice-cream\". We literally say \"ice-cream is necessary to me\". We know, it's strange! Notice that \"ice-cream\" is the subject here, not \"me\".";

        SpannableStringBuilder ssBuilder = new SpannableStringBuilder(str);
        String keyword0="нужен";
        String keyword1="должен";
        ...
        final Uri uri0=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/ineed1_sent1");
        final Uri uri1=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/ineed1_sent1"); // header1
        final Uri uri2=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/ineed1_sent2");
        final Uri uri3=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/ineed1_sent3");
        final Uri uri4=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/ineed1_sent4");
