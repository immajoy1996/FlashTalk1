...
public class RussianISaidItPerfectiveActualFragment2 extends Fragment {
    ...
    public RussianISaidItPerfectiveActualFragment2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_isaid_it_perfective_actual_fragment2, container, false);
        //android.support.v7.widget.Toolbar Toolbar=rootView.findViewById(R.id.toolbar);
        //Toolbar.setTitle("Basic Verbs");

        ImageButton back_button = (ImageButton) rootView.findViewById(R.id.back_button);
        //ImageButton forward_button=(ImageButton)rootView.findViewById(R.id.forward_button);
        final ViewPager viewPager = getActivity().findViewById(R.id.isaiditperfectiveactual_pager);
        ...
        games.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("LESSON_NAME","I Said It!");
                //pause.setVisibility(View.GONE);
                //volume.setVisibility(View.VISIBLE);
        ...
        String str1 = "Он сказал что он был в магазине.";
        String keyword1 = "сказал";
        ...
        String str2 = "В классе, она сказала что я хороший студент.";
        String keyword2 = "сказала";
        ...
        String str3 = "Каждый день, она говорила о политике.";
        String keyword3 = "говорила";
