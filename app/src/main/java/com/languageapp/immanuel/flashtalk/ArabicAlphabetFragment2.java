...
public class ArabicAlphabetFragment2 extends Fragment {

    //MediaPlayer mediaPlayer
    int STEP_TIME=100;
    RecyclerViewAdapterArabicPractice adapter;
    ...
    public ArabicAlphabetFragment2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_arabic_alphabet_fragment2, container, false);
        ...
        adapter = new RecyclerViewAdapterArabicPractice(getContext(), lett,traslit);
