...
public class RussianVocabFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        translit.add("moo-shee-na");translit.add("zhen-shchee-na");
        translit.add("chee-la-vyek");translit.add("de-vush-ka");translit.add("droog");translit.add("ma-ma");
        translit.add("pa-pa");translit.add("brat");translit.add("cees-tra");
