...
public class RussianAccusativeCaseFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        spannableString_rule1.setSpan(new StyleSpan(Typeface.BOLD),rule1_str.indexOf("а"),rule1_str.indexOf("а")+1, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        spannableString_rule1.setSpan(new StyleSpan(Typeface.BOLD),rule1_str.indexOf("у"),rule1_str.indexOf("у")+1, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        ...
        spannableString_rule2.setSpan(new StyleSpan(Typeface.BOLD),rule2_str.indexOf("я"),rule2_str.indexOf("я")+1, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        spannableString_rule2.setSpan(new StyleSpan(Typeface.BOLD),rule2_str.indexOf("ю"),rule2_str.indexOf("ю")+1, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
