...
public class RecyclerViewAdapterRussAlphPractice extends RecyclerView.Adapter<RecyclerViewAdapterRussAlphPractice.ViewHolder> {
    ...
    RecyclerViewAdapterRussAlphPractice(Context context, List<String> data1 ,List<SpannableString> data2) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.alphabet_practice_rowview, parent, false);
