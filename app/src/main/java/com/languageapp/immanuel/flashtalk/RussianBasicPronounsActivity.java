...
public class RussianBasicPronounsActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_russian_basic_pronouns);
    ...
    private class BasicPronounsPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            if(position==0) {
                return new RussianBasicPronounsFragment1();
            }
            else if(position==1){
                return new RussianBasicPronounsFragment2();
            }
            else {
                return new RussianBasicPronounsFragment3();
            }
        }
