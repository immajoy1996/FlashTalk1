...
public class RussianImBoredActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_russian_im_bored);
        ...
        games.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("LESSON_NAME","I'm Bored");
        ...
        final Uri uri1=Uri.parse("android.resource://"+this.getPackageName()+"/raw/imbored_1");
        final Uri uri2=Uri.parse("android.resource://"+this.getPackageName()+"/raw/imbored_2");
        final Uri uri3=Uri.parse("android.resource://"+this.getPackageName()+"/raw/imbored_3");
        final Uri uri4=Uri.parse("android.resource://"+this.getPackageName()+"/raw/imbored_4");
        ...
        String str = "In Russian, we don't say \"I'm bored\". We literally say \"it's boring to me\". Get the pattern?";
