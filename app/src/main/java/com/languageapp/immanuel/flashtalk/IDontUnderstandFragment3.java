...
public class IDontUnderstandFragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_idont_understand_fragment3, container, false);
        ...
        String intro_str="чуть чуть is a popular slang phrase for \"a little bit.\" Look at the third example.";
