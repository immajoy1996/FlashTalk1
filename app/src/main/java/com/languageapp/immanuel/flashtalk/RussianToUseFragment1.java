...
public class RussianToUseFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_to_use_fragment1, container, false);
        ...
        final ViewPager viewPager=getActivity().findViewById(R.id.touse_pager);
        ...
        final Uri uri1=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/to_use1_frag1_sentence1"); // header1
        final Uri uri2=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/to_use1_frag1_sentence2");
        final Uri uri3=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/to_use1_frag1_sentence3");
        final Uri uri4=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/to_use1_frag1_sentence4");
        final Uri uri5=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/to_use1_frag1_sentence5"); // header2
        final Uri uri6=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/to_use1_frag1_sentence6");
        final Uri uri7=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/to_use1_frag1_sentence7");
