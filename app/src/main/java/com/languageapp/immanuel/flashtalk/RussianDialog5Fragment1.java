...
public class RussianDialog5Fragment1 extends Fragment {
    ...
    public RussianDialog5Fragment1() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_dialog5_fragment1, container, false);
        ...
        String str1="ЛЕНА : Привет. Ты новый студент? Кто ты?";
        String trans1="Hi. Are you the new student? Who are you?";
        ...
        String str2="МЭННИ : Да. Я Мэнни. Я американский студент. Кто ты?";
        String trans2="Yes. I'm Manny. I'm an American student. Who are you?";
        String str2_name="МЭННИ :";
        ...
        String str3="ЛЕНА : Я Лена. Ты любишь этот университет?";
        String trans3="I'm Lena. Do you like this university?";
        ...
        String str4="МЭННИ : Нет. Я не люблю это.";
        String trans4="No. I don't like it.";
        //String str4_keyword1="Каждый";
        //String trans4_keyword1="Every";
        String str4_name="МЭННИ :";
        ...
        String str5="ЛЕНА : Правда? Почему?";
        String trans5="Really? Why?";
        ...
        String str6="МЭННИ : Потому что этот университет очень скучный.";
        String trans6="Because this university is very boring.";
        String str6_name="МЭННИ :";
        String str6_keyword1="скучный";
        String trans6_keyword1="boring";
        ...
        String str7="ЛЕНА : Тогда . . . почему ты студент здесь?";
        String trans7="Then . . . why are you a student here?";
        String str7_name="ЛЕНА :";
        String str7_keyword1="Тогда";
        String trans7_keyword1="Then";
        ...
        String str8="МЭННИ : Потому что я люблю отличный фитнес-центр  здесь.";
        String trans8="Because I love the excellent fitness center here.";
        String str8_name="МЭННИ :";
        ...
        String str9="ЛЕНА : Что! Ты студент здесь потому что здесь хороший фитнес-центр!";
        String trans9="What! You're a student here because there's a good fitness center here!";
        ...
        String str10="МЭННИ : Да!";
        String trans10="Yes!";
        String str10_name="МЭННИ :";
        ...
        String str11="ЛЕНА : Ты очень интересный человек!";
        String trans11="You're a very interesting person.";
        ...
        String str12="МЭННИ : Спасибо, Лена.";
        String trans12="Thanks, Lena.";
        String str12_name="МЭННИ :";
