...
public class RussianToGoOnFootFragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String str1="Я иду в библиотеку.";
        ...
        String str2="Я иду в твою комнату сейчас.";
        ...
        final Uri uri1=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/idoo1");
        final Uri uri2=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/idoo2");
        final Uri uri3=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/idoo3");
