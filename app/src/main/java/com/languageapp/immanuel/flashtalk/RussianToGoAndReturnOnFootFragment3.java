...
public class RussianToGoAndReturnOnFootFragment3 extends Fragment {
    ...
    public RussianToGoAndReturnOnFootFragment3() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_to_go_and_return_on_foot_fragment3, container, false);
        ...
        games.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("LESSON_NAME","To Go And Come Back (On Foot)");
                //pause.setVisibility(View.GONE);
                //volume.setVisibility(View.VISIBLE);
        ...
        final Uri uri1=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/xod1");
        final Uri uri2=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/xod2");
        final Uri uri3=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/xod3");
