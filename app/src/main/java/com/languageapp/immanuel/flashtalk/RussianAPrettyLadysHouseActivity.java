...
public class RussianAPrettyLadysHouseActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_russian_apretty_ladys_house);

        ImageButton back_button=(ImageButton)findViewById(R.id.back_button);
        //ImageButton forward_button=(ImageButton)findViewById(R.id.forward_button);
        final ViewPager viewPager=findViewById(R.id.prettywoman_pager);
        ...
        String str1="Это дом хорошого друга.";

        SpannableString spannableString1=new SpannableString(str1);
        spannableString1.setSpan(new UnderlineSpan(), str1.indexOf("хорошого"), str1.indexOf("хорошого")+8, 0);
