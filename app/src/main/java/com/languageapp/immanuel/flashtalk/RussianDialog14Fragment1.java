...
public class RussianDialog14Fragment1 extends Fragment {
    ...
    public RussianDialog14Fragment1() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_dialog14_fragment1, container, false);
        ...
        String str1="НАТАША : Привет, Чарли. Ты из России?";
        String trans1="Hello, Charlie. Are you from Russia?";
        ...
        String str2="ЧАРЛИ : Нет, я живу в Америки и говорю по-английски..";
        String trans2="No, I live in America and speak English.";
        String str2_name="ЧАРЛИ :";
        ...
        String str3="НАТАША : Правда? Какой город?";
        String trans3="Really? Which city?";
        ...
        String str5="НАТАША : Чарли, Париж не в Америке.";
        String trans5="Charlie, Paris is not city in America";
        ...
        String str6="ЧАРЛИ : Правда? Хмм . . .";
        String trans6="Really? Hmm . . .";
        String str6_name="ЧАРЛИ :";
        ...
        String str7="НАТАША : Где ты изучал русский? В твоём университете?";
        String trans7="Where did you study Russian? In your university?";
        ...
        String str8="ЧАРЛИ : О, я изучал русский когда жил в Париже. Люди там говорят по-русски.";
        String trans8="Oh, I studied Russian when I lived in Paris. People there speak Russian.";
        String str8_name="ЧАРЛИ :";
        String str8_keyword1="когда";
        String trans8_keyword1="when";
        ...
        String str9="НАТАША : Это неправда. Люди в Париже говорят по-французски.";
        String trans9="That's not true. People in Paris speak French.";
        ...
        String str10="ЧАРЛИ : Правда? Хмм . . .";
        String trans10="Really? Hmm . . .";
        String str10_name="ЧАРЛИ :";
        ...
        String str11="НАТАША :  Какая твоя профессия?";
        String trans11="What's your profession?";
        ...
        String str12="ЧАРЛИ : О, я доктор. Я работаю в библиотеке.";
        String trans12="Oh, I'm a doctor. I work in a library.";
        String str12_name="ЧАРЛИ :";
        ...
        String str13="НАТАША : Чарли, это секретарь. Почему ты никогда не говоришь правду?";
        String trans13="Charlie, that's a secretary. Why do you never tell the truth?";
        String str13_name="НАТАША :";
        String str13_keyword1="никогда не";
        String trans13_keyword1="never";
        //String str13_keyword2="Может быть";
        //String trans13_keyword2="Maybe";
        ...
        spannableString13.setSpan(new UnderlineSpan(),str13.indexOf(str13_keyword1),str13.indexOf(str13_keyword1)+str13_keyword1.length(),0);
        spannableString13_trans.setSpan(new UnderlineSpan(),trans13.indexOf(trans13_keyword1),trans13.indexOf(trans13_keyword1)+trans13_keyword1.length(),0);
        //spannableString13.setSpan(new UnderlineSpan(),str13.indexOf(str13_keyword2),str13.indexOf(str13_keyword2)+str13_keyword2.length(),0);
        //spannableString13_trans.setSpan(new UnderlineSpan(),trans13.indexOf(trans13_keyword2),trans13.indexOf(trans13_keyword2)+trans13_keyword2.length(),0);
        ...
        String str14="ЧАРЛИ : Хмм . . .";
        String trans14="Hmm . . .";
        String str14_name="ЧАРЛИ :";
        ...
        final Uri uri11=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/isj7");
        final Uri uri12=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/dimi4");
        final Uri uri13=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/isj9");
        final Uri uri14=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/dimi5");
        ...
        linearLayout13.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View view) {
                /*mediaPlayer.stop();
                mediaPlayer.release();
