...
public class RussianDialogActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog_images.add("N/A");
        dialog_images.add("kettlebell");
        dialog_images.add("waiter");
        dialog_images.add("hamburger");
        dialog_images.add("wild");
        dialog_images.add("boringman");
        dialog_images.add("N/A");
        dialog_images.add("whouse");
        dialog_images.add("liar");
        dialog_images.add("frust");
        dialog_images.add("army");
        dialog_images.add("love");
        ...
        dialog_titles.add("Donald And Vladimir");
        dialog_titles.add("A Liar");
        dialog_titles.add("Frustration");
        dialog_titles.add("A Hidden Joke");
        dialog_titles.add("True Love");
