...
public class RussianWhatAreYouTalkingAboutFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_what_are_you_talking_about_fragment1, container, false);
        ...
        String str="о means \"about\". Anything after о takes the prepositional case. We already know this one!";
        String keyword1_intro="о means";
        String keyword2_intro="о takes";
        ...
        String str1="Мы говорим о политике.";
        String keyword1="политике";
        ...
        String str2="Я говорю о ресторане.";
        String keyword2="ресторане";
        ...
        String str3="Ты думаешь о классе?";
        String keyword3="классе";
        ...
        final Uri uri1=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/whatutalkingabout1_1"); // header1
        final Uri uri2=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/whatutalkingabout1_2");
        final Uri uri3=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/whatutalkingabout1_3");
