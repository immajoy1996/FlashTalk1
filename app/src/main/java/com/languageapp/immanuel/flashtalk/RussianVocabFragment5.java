...
public class RussianVocabFragment5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        translit.add("a-deen");translit.add("dva");translit.add("tree");translit.add("chee-ty-ree"); translit.add("pyat");
        translit.add("shest");translit.add("syem");translit.add("vo-syem"); translit.add("dye-vit");
        translit.add("dye-sit");
