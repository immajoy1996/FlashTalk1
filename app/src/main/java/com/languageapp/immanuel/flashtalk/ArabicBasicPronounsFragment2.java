...
public class ArabicBasicPronounsFragment2 extends Fragment {
    ...
    public ArabicBasicPronounsFragment2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_arabic_basic_pronouns_fragment2, container, false);
