...
public class RussianVocabFragment6 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        translit.add("oo-tra");translit.add("vye-cher");translit.add("zhee-zn");translit.add("lyu-bof"); translit.add("got");
        translit.add("mye-sits");translit.add("nye-dye-lya");translit.add("chas"); translit.add("meen-oot");
