...
public class RussianISaidItFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_isaid_it_fragment2, container, false);
        ...
        String str1="В классе мы говорили о политике.";
        String keyword1="говорили";
        ...
        String str2="В классе она говорила о книге.";
        String keyword2="говорила";
        ...
        String str3="Вчера вы говорили о президенте.";
        String keyword3="говорили";
        ...
        games.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("LESSON_NAME","We Talked!");
                //pause.setVisibility(View.GONE);
                //volume.setVisibility(View.VISIBLE);
        ...
        final Uri uri1=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/wetalked2_1"); // header1
        final Uri uri2=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/wetalked2_2");
        final Uri uri3=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/wetalked2_3");
