...
public class RussianDialog3Fragment1 extends Fragment {
    ...
    public RussianDialog3Fragment1() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_dialog3_fragment1, container, false);
        ...
        final ViewPager viewPager=getActivity().findViewById(R.id.dialog3_pager);
        ...
        String str1="ЛЕНА : Димитрий, почему ты изучаешь русский язык?";
        String trans1="Dimitry, why are you studying Russian?";
        ...
        String str2="ДИМИТРИЙ : Потому что русский очень интересный и важный язык.";
        String trans2="Because Russian is a very interesting and important language.";
        String str2_name="ДИМИТРИЙ :";
        ...
        String str3="ЛЕНА : Хорошо. Ты изучаешь Дуолинго?";
        String trans3="Okay. Do you study Duolingo?";
        ...
        String str4="ДИМИТРИЙ : Да. Каждый день, я изучаю Дуолинго.";
        String trans4="Yes. Every day, I study Duolingo.";
        String str4_keyword1="Каждый";
        String trans4_keyword1="Every";
        String str4_name="ДИМИТРИЙ :";
        ...
        String str6="ДИМИТРИЙ : Что??";
        String trans6="What??";
        String str6_name="ДИМИТРИЙ :";
        ...
        String str7="ЛЕНА : Как по-русски \"United Nations\"?";
        String trans7="How do you say \"United Nations\" in Russian?";
        ...
        String str8="ДИМИТРИЙ : Я знаю! Организация Объединённых Наций.";
        ...
        final Uri uri12=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/dimi6");
        final Uri uri13=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/isj13");
        final Uri uri14=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/dimi7");
        final Uri uri15=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/isj15");
