...
public class RussianQuestionWordsFragment3 extends Fragment {
    ...
    public RussianQuestionWordsFragment3() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_question_words_fragment3, container, false);
        //Toolbar toolbar = (Toolbar)rootView.findViewById(R.id.toolbar_fragment3);
        //toolbar.setTitle("More Examples");

        final Uri uri1=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/question_words2_sentence1");
        final Uri uri2=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/question_words2_sentence2");
        final Uri uri3=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/question_words2_sentence3");
        ...
        String intro_str="Notice that это is used in the place of 'this', 'that' and 'it' in English.";
        SpannableString spannableString_intro=new SpannableString(intro_str);
        String keyword="это";
        spannableString_intro.setSpan(new StyleSpan(Typeface.BOLD),intro_str.indexOf(keyword),intro_str.indexOf(keyword)+keyword.length(),0);
        spannableString_intro.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.medium_sea_green)),intro_str.indexOf(keyword),intro_str.indexOf(keyword)+keyword.length(),0);
        intro.setText(spannableString_intro);

        //final int MAX=mediaPlayer.getDuration() / STEP_TIME;

        /*final Uri uri=Uri.parse("android.resource://"+rootView.getContext().getPackageName()+"/raw/question_words2_sentence1");
