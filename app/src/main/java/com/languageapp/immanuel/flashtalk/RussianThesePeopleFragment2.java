...
public class RussianThesePeopleFragment2 extends Fragment {
    ...
    public RussianThesePeopleFragment2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_these_people_fragment2, container, false);
        ...
        games.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("LESSON_NAME","These People");
                //pause.setVisibility(View.GONE);
                //volume.setVisibility(View.VISIBLE);
