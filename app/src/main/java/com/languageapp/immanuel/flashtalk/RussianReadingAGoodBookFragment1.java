...
public class RussianReadingAGoodBookFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_reading_agood_book_fragment1, container, false);
        //android.support.v7.widget.Toolbar Toolbar=rootView.findViewById(R.id.toolbar);
        //Toolbar.setTitle("Basic Verbs");

        ImageButton back_button=(ImageButton)rootView.findViewById(R.id.back_button);
        ImageButton forward_button=(ImageButton)rootView.findViewById(R.id.forward_button);
        final ViewPager viewPager=getActivity().findViewById(R.id.readingagoodbook_pager);
        ...
        String str1="Я смотрю интересный фильм.";
        String keyword1="интересный";
        ...
        String str2="Я читаю интересную книгу.";
        String keyword2="интересную";
        ...
        String str3="Я вижу интересное фото.";
        String keyword3="интересное";
        ...
        final Uri uri1=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/interesni1");
        final Uri uri2=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/interesni2");
        final Uri uri3=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/interesni3");
