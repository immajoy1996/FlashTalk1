...
public class RussianPrepositionalExceptionsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_russian_prepositional_exceptions);
        ...
        games.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("LESSON_NAME","In The Morning");
        ...
        final Uri uri1=Uri.parse("android.resource://"+this.getPackageName()+"/raw/doma1");
        final Uri uri2=Uri.parse("android.resource://"+this.getPackageName()+"/raw/doma2");
        final Uri uri3=Uri.parse("android.resource://"+this.getPackageName()+"/raw/doma3");
        ...
        String str = "Sometimes, we say things a little differently.";
