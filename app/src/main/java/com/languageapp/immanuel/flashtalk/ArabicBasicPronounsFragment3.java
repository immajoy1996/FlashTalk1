...
public class ArabicBasicPronounsFragment3 extends Fragment {
    ...
    public ArabicBasicPronounsFragment3() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_arabic_basic_pronouns_fragment3, container, false);
