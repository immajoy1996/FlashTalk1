...
public class RussianISaidItFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final Uri uri0=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/govareet");
        final Uri uri1=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/italked1"); // header1
        final Uri uri2=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/italked2");
        final Uri uri3=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/italked3");
        final Uri uri4=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/italked4");
