...
public class RussianMyFriendsHouseFragment1 extends Fragment {
    ...
    public RussianMyFriendsHouseFragment1() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_my_friends_house_fragment1, container, false);
