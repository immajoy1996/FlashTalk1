...
public class RussianImFromAmericaFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String str="To ask where someone's from, use откуда (ot-koo-da). It literally means \"from where.\" Remember that вы is also a formal way to say \"you\".";
        String keyword1="откуда (ot-koo-da)";
        String keyword2="вы";
        String keyword3="ot-koo-da";
        ...
        spannableString.setSpan(new StyleSpan(Typeface.BOLD), str.indexOf(keyword1), str.indexOf(keyword1)+6, 0);
        ...
        final Uri uri1=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/wuf1"); // header1
        final Uri uri2=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/wuf2");
        final Uri uri3=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/wuf3");
