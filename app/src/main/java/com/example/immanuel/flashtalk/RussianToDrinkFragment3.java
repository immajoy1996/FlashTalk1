...
public class RussianToDrinkFragment3 extends Fragment {
    ...
    public RussianToDrinkFragment3() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_to_drink_fragment3, container, false);
        ...
        games.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                endit();
                intent.putExtra("LESSON_NAME","To Drink");
                //pause.setVisibility(View.GONE);
                //volume.setVisibility(View.VISIBLE);
