...
public class RussianToSeeFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_to_see_fragment2, container, false);
        ...
        String str1="Я не вижу тебя.";
        String keyword1="тебя";
        ...
        String str3="Ты ещё не видишь меня?";
        String keyword3="меня";
