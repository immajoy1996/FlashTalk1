...
public class RussianReadingAGoodBookFragment2 extends Fragment {
    ...
    public RussianReadingAGoodBookFragment2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_reading_agood_book_fragment2, container, false);
        ...
        games.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("LESSON_NAME","Reading A Good Book");
                //pause.setVisibility(View.GONE);
                //volume.setVisibility(View.VISIBLE);
