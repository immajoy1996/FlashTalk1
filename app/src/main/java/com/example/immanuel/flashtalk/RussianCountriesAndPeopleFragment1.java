...
public class RussianCountriesAndPeopleFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String str1="Russia - Россия (ross-i-ya)";
        String keyword1="Россия (ross-i-ya)";
        String a1="Россия";
        String a2="ross-i-ya";
        ...
        String str2="America - Америка (am-yer-i-ka)";
        String keyword2="Америка (am-yer-i-ka)";
        String b1="Америка";
        String b2="am-yer-i-ka";
        ...
        String str3="France - Франция (fran-ts-i-ya)";
        String keyword3="Франция (fran-ts-i-ya)";
        String c1="Франция";
        String c2="fran-ts-i-ya";
