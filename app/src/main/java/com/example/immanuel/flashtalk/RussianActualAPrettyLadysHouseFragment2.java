...
public class RussianActualAPrettyLadysHouseFragment2 extends Fragment {
    ...
    public RussianActualAPrettyLadysHouseFragment2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_actual_apretty_ladys_house_fragment2, container, false);
        ...
        games.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("LESSON_NAME","My Pretty Lady's House");
                //pause.setVisibility(View.GONE);
                //volume.setVisibility(View.VISIBLE);
