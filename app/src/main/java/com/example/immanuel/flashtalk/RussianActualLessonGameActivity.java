...
public class RussianActualLessonGameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_russian_actual_lesson_game);
        ...
        //for(int i=0;i<return_string.length();i++){
            //if(return_string.charAt(i)=='1'){
                switch (lesson_name){
                    ...
                    /*case "I, You, He, She": //Beginner
                        Game_BasicPronouns game_beginner=new Game_BasicPronouns();
                    ...
                    case "We, They":
                        Game_Functional game_functional1=new Game_Functional();
                        total+=game_functional1.TOTAL;
                        for(int j=0;j<game_functional1.TOTAL;j++){
                            Types.add(game_functional1.getType(j));
                            Instructions.add(game_functional1.getInstruction(j));
                            Questions.add(game_functional1.getQuestion(j));
                            Answer1.add(game_functional1.getAnswer1(j));
                            Answer2.add(game_functional1.getAnswer2(j));
                            Answer3.add(game_functional1.getAnswer3(j));
                            Answer4.add(game_functional1.getAnswer4(j));
                            CorrectAnswer.add(game_functional1.getCorrectAnswer(j));
                        }
                        break;
                    case "Wrap Up":
                        Game_Functional game_functional2=new Game_Functional();
                        total+=game_functional2.TOTAL;
                        for(int j=0;j<game_functional2.TOTAL;j++){
                            Types.add(game_functional2.getType(j));
                            Instructions.add(game_functional2.getInstruction(j));
                            Questions.add(game_functional2.getQuestion(j));
                            Answer1.add(game_functional2.getAnswer1(j));
                            Answer2.add(game_functional2.getAnswer2(j));
                            Answer3.add(game_functional2.getAnswer3(j));
                            Answer4.add(game_functional2.getAnswer4(j));
                            CorrectAnswer.add(game_functional2.getCorrectAnswer(j));
                        }
                        break;
                    case "I Don't Understand":
                        Game_Functional game_functional3=new Game_Functional();
                        total+=game_functional3.TOTAL;
                        for(int j=0;j<game_functional3.TOTAL;j++){
                            Types.add(game_functional3.getType(j));
                            Instructions.add(game_functional3.getInstruction(j));
                            Questions.add(game_functional3.getQuestion(j));
                            Answer1.add(game_functional3.getAnswer1(j));
                            Answer2.add(game_functional3.getAnswer2(j));
                            Answer3.add(game_functional3.getAnswer3(j));
                            Answer4.add(game_functional3.getAnswer4(j));
                            CorrectAnswer.add(game_functional3.getCorrectAnswer(j));
                        }
                        break;
                    case "I'm Studying":
                        Game_Functional game_functional4=new Game_Functional();
                        total+=game_functional4.TOTAL;
                        for(int j=0;j<game_functional4.TOTAL;j++){
                            Types.add(game_functional4.getType(j));
                            Instructions.add(game_functional4.getInstruction(j));
                            Questions.add(game_functional4.getQuestion(j));
                            Answer1.add(game_functional4.getAnswer1(j));
                            Answer2.add(game_functional4.getAnswer2(j));
                            Answer3.add(game_functional4.getAnswer3(j));
                            Answer4.add(game_functional4.getAnswer4(j));
                            CorrectAnswer.add(game_functional4.getCorrectAnswer(j));
                        }
                        break;
                    case "Nouns":
                        Game_Functional game_functional5=new Game_Functional();
                        total+=game_functional5.TOTAL;
                        for(int j=0;j<game_functional5.TOTAL;j++){
                            Types.add(game_functional5.getType(j));
                            Instructions.add(game_functional5.getInstruction(j));
                            Questions.add(game_functional5.getQuestion(j));
                            Answer1.add(game_functional5.getAnswer1(j));
                            Answer2.add(game_functional5.getAnswer2(j));
                            Answer3.add(game_functional5.getAnswer3(j));
                            Answer4.add(game_functional5.getAnswer4(j));
                            CorrectAnswer.add(game_functional5.getCorrectAnswer(j));
                        }
                        break;*/
                }
           // }
