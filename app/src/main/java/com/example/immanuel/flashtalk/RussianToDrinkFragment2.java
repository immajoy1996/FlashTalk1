...
public class RussianToDrinkFragment2 extends Fragment {
    ...
    public RussianToDrinkFragment2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_to_drink_fragment2, container, false);
