...
public class RussianDialog7Fragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String str7="НАТАША : Нет. Ты видишь монумент? Потом, ты идёшь прямо и потом, налево. Макдональдс там.";
        String trans7="No. You see the monument?. After it, you go straight and then left. The Mcdonalds is there.";
        ...
        String str9="НАТАША : Да. Это тоже очень красиво! ";
        String trans9="Yes. It's also very beautiful!";
