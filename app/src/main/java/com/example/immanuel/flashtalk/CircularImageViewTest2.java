 ...
 */
public class CircularImageViewTest2 extends AppCompatImageView {

    // Default Values
    private final float DEFAULT_BORDER_WIDTH = getResources().getInteger(R.integer.circular_image_view_test_width);
    ...
    public CircularImageViewTest2(final Context context) {
        this(context, null);
    }

    public CircularImageViewTest2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircularImageViewTest2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attributes.getBoolean(R.styleable.CircularImageView_civ_border, true)) {
            ...
            setBorderColor(attributes.getColor(R.styleable.CircularImageView_civ_border_color, getResources().getColor(R.color.medium_sea_green)));
        }

        setBackgroundColor(attributes.getColor(R.styleable.CircularImageView_civ_background_color, getResources().getColor(R.color.medium_sea_green)));
