...
public class RussianDialog1Fragment2 extends Fragment {
    ...
    public RussianDialog1Fragment2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_dialog1_fragment2, container, false);
        ...
        games.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("LESSON_NAME","Dialogue 1 - A Testy Exchange");
                //pause.setVisibility(View.GONE);
                //volume.setVisibility(View.VISIBLE);
