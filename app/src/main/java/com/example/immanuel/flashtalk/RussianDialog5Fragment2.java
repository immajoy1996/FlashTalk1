...
public class RussianDialog5Fragment2 extends Fragment {
    ...
    public RussianDialog5Fragment2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_dialog5_fragment2, container, false);
        ...
        games.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("LESSON_NAME","Dialogue 5 - A Rebel");
                //pause.setVisibility(View.GONE);
                //volume.setVisibility(View.VISIBLE);
