...
public class RussianBasicVerbsFragment1 extends Fragment {
    ...
    public RussianBasicVerbsFragment1() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String intro1="Most Russian verbs end with the silent soft sign ь. Here are three very common verbs. Swipe to see examples.";
        ...
        spannableString_intro2.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.medium_sea_green)), intro2.indexOf(intro_keyword2), intro2.indexOf(intro_keyword2)+intro_keyword2.length(), 0);
        spannableString_intro2.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.medium_sea_green)), intro2.indexOf(intro_keyword3), intro2.indexOf(intro_keyword3)+intro_keyword3.length(), 0);
        //spannableString_intro.setSpan(new StyleSpan(Typeface.BOLD), intro.indexOf(intro_keyword4), intro.indexOf(intro_keyword4)+2, 0);
        spannableString_intro1.setSpan(new StyleSpan(Typeface.BOLD), intro1.indexOf(intro_keyword1), intro1.indexOf(intro_keyword1)+intro_keyword1.length(), 0);
        spannableString_intro2.setSpan(new StyleSpan(Typeface.BOLD), intro2.indexOf(intro_keyword2), intro2.indexOf(intro_keyword2)+intro_keyword2.length(), 0);
        ...
        textView_intro2.setText(spannableString_intro2);
        ...
        /*final Uri uri=Uri.parse("android.resource://"+rootView.getContext().getPackageName()+"/raw/basic_verbs_fragment1_sentence1");
