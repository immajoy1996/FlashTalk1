...
public class RussianDialog2Fragment1 extends Fragment {
    ...
    public RussianDialog2Fragment1() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final ViewPager viewPager=getActivity().findViewById(R.id.dialog2_pager);
        ...
        String str1="РИЧАРД : Привет Лена. Это мой друг, Джон. Он турист здесь и говорит по-английски.";
        String trans1="Hi Lena. This is my friend, John. He's a tourist here and speaks English.";
        String str1_name="РИЧАРД :";
        ...
        String str2="ЛЕНА : Правда? Джон, ты тоже говоришь по-русски?";
        String trans2="Really? John, do you also speak Russian?";
        String str2_name="ЛЕНА :";
        String str2_keyword1="Правда";
        String trans2_keyword1="Really";
        String str2_keyword2="тоже";
        String trans2_keyword2="also";
        ...
        String str3_name="ДЖОН :";

        SpannableString spannableString3=new SpannableString(str3);
        SpannableString spannableString3_trans=new SpannableString(trans3);
        //spannableString3.setSpan(new UnderlineSpan(),str3.indexOf(str3_name),str3.indexOf(str3_name)+str3_name.length(),0);
        ...
        String str4="ЛЕНА : Правда? Как ты знаешь русский?";
        String trans4="Really? How do you know Russian?";
        //String str4_keyword1="конечно";
        //String trans4_keyword1="of course";
        String str4_name="ЛЕНА :";
        ...
        String str6="ЛЕНА : Что? Я не понимаю.";
        String trans6="What? I don't understand.";
        String str6_name="ЛЕНА :";
        //String str5_keyword1="почему";
        //String trans5_keyword1="why";
        ...
        String str7="РИЧАРД : Ой, Джон только знает \"да\" по-русски. ";
        String trans7="Oh, John only knows \"yes\" in Russian.";
        String str7_name="РИЧАРД :";
        String str7_keyword1="Ой";
        String trans7_keyword1="Oh";
        String str7_keyword2="только";
        String trans7_keyword2="only";
        ...
        String str8="ЛЕНА : Ха-ха. Правда? Джон, ты знаешь, что мы говорим?";
        String trans8="Ha ha. Really? John, do you know what we're saying?";
        String str8_name="ЛЕНА :";
        String str8_keyword1="Ха-ха";
        String trans8_keyword1="Ha ha";
        ...
        String str10="ЛЕНА : Хорошо. Пока Ричард! Пока Джон!";
        String trans10="Okay. Bye Richard! Bye John!";
        String str10_name="ЛЕНА :";
        //String str5_keyword1="почему";
        //String trans5_keyword1="why";
        ...
        String str11="РИЧАРД : Пока Лена!";
        String str11_name="РИЧАРД :";
        String trans11="Bye Lena!";
