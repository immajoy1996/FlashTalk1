...
public class RussianTheBestFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_the_best_fragment2, container, false);
        ...
        games.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("LESSON_NAME","The Best");
                //pause.setVisibility(View.GONE);
                //volume.setVisibility(View.VISIBLE);
        ...
        String str="Remember that лучше means \"better\". Here's how you say \"best\". This one is very useful!";
        String keyword1_intro="лучше";
        ...
        String str1="Он мой самый лучший друг.";
        ...
        String str2="Америка самая лучшая страна.";
        ...
        String str3="Это самое лучшое место.";
