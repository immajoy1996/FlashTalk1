...
public class AlphabetFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        SpannableString str2 = new SpannableString("a-tom");
        SpannableString str3 = new SpannableString("mot-or");
        ...
        SpannableString str7 = new SpannableString("pas-port");
        SpannableString str8 = new SpannableString("metr");
        SpannableString str9 = new SpannableString("er-a");
        SpannableString str10 = new SpannableString("eks-port");
        SpannableString str11 = new SpannableString("or-kes-tr");
        SpannableString str12 = new SpannableString("res-to-ran");
        SpannableString str13 = new SpannableString("im-port");
