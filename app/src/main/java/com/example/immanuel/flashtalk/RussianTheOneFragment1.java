...
public class RussianTheOneFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_the_one_fragment1, container, false);
        //android.support.v7.widget.Toolbar Toolbar=rootView.findViewById(R.id.toolbar);
        //Toolbar.setTitle("Basic Verbs");

        TextView textView_intro=rootView.findViewById(R.id.intro);
        String str_intro="The number \"one\" in Russian acts like an adjective. It's really simple! There are similar rules for the numbers 2-10 but they are not very important to know for now. You'll learn the numbers 1-10 in the next section.";
        ...
        String str1="один (a-deen) человек";
        ...
        String str2="одна (ad-na) девушка";
