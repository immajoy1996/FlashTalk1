...
public class RussianToUseFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_to_use_fragment2, container, false);
        ...
        String intro_str="Let's see some examples.";
        String keyword1="чуть чуть";
        ...
        final Uri uri1=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/touse2_sent1");
        final Uri uri2=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/touse2_sent2");
        final Uri uri3=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/touse2_sent3");
