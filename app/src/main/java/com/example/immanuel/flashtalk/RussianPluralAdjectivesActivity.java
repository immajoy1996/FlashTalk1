...
public class RussianPluralAdjectivesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_russian_plural_adjectives);
        ...
        String str1="Они интересные люди.";
        String keyword1="интересные";
        ...
        String str2="Я люблю интересные книги.";
        String keyword2="интересные";
