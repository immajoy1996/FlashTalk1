...
public class RussianYoureTalkingAboutMyFriendFragment1 extends Fragment {
    ...
    public RussianYoureTalkingAboutMyFriendFragment1(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String str1="Он в моём (ma-yom) доме.";
        String keyword1="моём (ma-yom) доме";
        ...
        String str2="Она в моём (ma-yey) доме.";
        String keyword2="моём (ma-yey) доме";
        ...
        String str3="Они в моём (ma-yom) месте.";
        String keyword3="моём (ma-yom) месте";
        ...
        String str4="Он в твоём (tva-yom) доме?";
        String keyword4="твоём (tva-yom) доме";
        ...
        String str5="Она в твоей (tva-yey) доме?";
        String keyword5="твоей (tva-yey) доме";
        ...
        String str6="Они в твоём (tva-yom) месте?";
        String keyword6="твоём (tva-yom) месте";
