...
public class RussianYoureTalkingAboutMyFriendFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_youre_talking_about_my_friend_fragment1, container, false);
        ...
        String str="Possessive pronouns change their forms in the prepositional case. Notice that the masc. and neut. forms are the same like always. Get the pattern?";
        ...
        String str2="Она в моей комнате";
        ...
        String str5="Она в твоей комнате?";
