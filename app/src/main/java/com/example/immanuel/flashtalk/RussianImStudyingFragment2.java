...
public class RussianImStudyingFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_im_studying_fragment2, container, false);
        ...
        String intro_str="Notce that изучать by itself is just \"to study.\" Look at the second example.";
        String keyword1="изучать";
        ...
        //final Uri uri=Uri.parse("android.resource://"+rootView.getContext().getPackageName()+"/raw/imstudying_fragment1_sentence1");
