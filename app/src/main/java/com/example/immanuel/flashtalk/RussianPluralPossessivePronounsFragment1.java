...
public class RussianPluralPossessivePronounsFragment1 extends Fragment {
    ...
    public RussianPluralPossessivePronounsFragment1() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_plural_possessive_pronouns_fragment1, container, false);
