...
public class RussianToGoAndReturnOnFootFragment2 extends Fragment {
    ...
    public RussianToGoAndReturnOnFootFragment2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_to_go_and_return_on_foot_fragment2, container, false);
