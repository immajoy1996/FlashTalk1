...
public class AlphabetFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        str21.setSpan(new UnderlineSpan(), 0, 2, 0);

        SpannableString str22 = new SpannableString("alzheimers"); //ж
        str22.setSpan(new UnderlineSpan(), 2, 4, 0);
        ...
        SpannableString str25 = new SpannableString("yucky"); //ю
        ...
        SpannableString str27 = new SpannableString("pushchair"); //щ
        str27.setSpan(new UnderlineSpan(), 2, 6, 0);
        ...
        SpannableString str33 = new SpannableString("silent letter!"); //ы
