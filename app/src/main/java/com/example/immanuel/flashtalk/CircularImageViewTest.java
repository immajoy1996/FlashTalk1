 ...
 */
public class CircularImageViewTest extends AppCompatImageView {
    ...
    public CircularImageViewTest(final Context context) {
        this(context, null);
    }

    public CircularImageViewTest(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircularImageViewTest(Context context, AttributeSet attrs, int defStyleAttr) {
