...
public class RussianImWatchingTVFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_russian_im_watching_tvfragment2, container, false);
        ...
        final ViewPager viewPager=getActivity().findViewById(R.id.watchingtv_pager);
        ...
        String intro_str="Remember that verbs ending in -еть are conjugated the same way as verbs ending in -ить.";
        String keyword1="-еть";
        String keyword2="-ить";
