...
public class RussianDialog10Fragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String str1="КАТЮША : Привет Офицер. Я хочу идти в мой самолёт.";
        String trans1="Hi, Officer. I want to go to my airplane.";
        String str1_keyword1="самолёт";
        String trans1_keyword1="airplane";
        String str1_name="КАТЮША :";
        ...
        String str2="ОФИЦЕР : Хорошо. Где твой паспорт? Я не вижу это. У тебя есть один?";
        String trans2="Okay. Where is your passport. I don't see it. Do you have one?";
        String str2_name="ОФИЦЕР :";
        ...
        String str3="КАТЮША : Паспорт? Нет.";
        String trans3="A passport? No.";
        String str3_name="КАТЮША :";
        //String str3_keyword1="роман";
        //String trans3_keyword1="novel";
        ...
        String str4="ОФИЦЕР : Хорошо. У тебя есть деньги для паспорта?";
        String trans4="Okay. Do you have money for a passport?";
        //String str4_keyword1="правда";
        //String trans4_keyword1="true";
        String str4_name="ОФИЦЕР :";
        ...
        String str5="КАТЮША : Да. Сколько?";
        String trans5="Yes. How much?";
        //String str5_keyword1="скучный";
        //String trans5_keyword1="boring";
        String str5_name="КАТЮША :";
        ...
        String str6="ОФИЦЕР : Пятьдесят.";
        String trans6="Fifty.";
        String str6_name="ОФИЦЕР :";
        String str6_keyword1="Пятьдесят";
        String trans6_keyword1="Fifty";
        ...
        String str7="КАТЮША : Хорошо. Вот пятьдесят.";
        String trans7="Okay. Here is fifty.";
        String str7_name="КАТЮША :";
        ...
        String str8="ОФИЦЕР : Хорошо. У тебя есть виза?";
        String trans8="Okay. Do you have a visa?";
        String str8_name="ОФИЦЕР :";
        ...
        String str9="КАТЮША : Виза? Нет.";
        String trans9="A visa? No.";
        String str9_name="КАТЮША :";
        ...
        String str10="ОФИЦЕР : Ну . . . у тебя есть деньги для визы?";
        String trans10="Well . . . do you have money for a visa?";
        String str10_name="ОФИЦЕР :";
        String str10_keyword1="Ну";
        String trans10_keyword1="Well";
        ...
        String str11="КАТЮША : Да. Сколько ты хочешь?";
        String trans11="Yes. How much do you want?";
        String str11_name="КАТЮША :";
        ...
        String str12="ОФИЦЕР : Пятьдесят, еще раз.";
        String trans12="Fifty, again.";
        String str12_name="ОФИЦЕР :";
        String str12_keyword1="еще раз";
        String trans12_keyword1="again";
        ...
        String str14="КАТЮША : Хорошо. Вот пятьдесят. Я могу идти в самолёт сейчас?";
        String trans14="Okay. Here's fifty. Can I go to the plane now?";
        String str14_name="КАТЮША :";
        ...
        String str15="ОФИЦЕР : Нет. У тебя есть деньги для паспорта и визы. У тебя есть деньги для меня?";
        String trans15="No. You have money for a passport and visa. Do you have money for me?";
        String str15_name="ОФИЦЕР :";
        ...
        String str16="КАТЮША : Нет! Что это!";
        String trans16="No! What's this!";
        String str16_name="КАТЮША :";
        ...
        String str17="ОФИЦЕР : Это бизнес.";
        String trans17="This is business.";
        String str17_name="ОФИЦЕР :";
        ...
        String str18="КАТЮША : Хорошо. Сколько?";
        String trans18="Okay. How much?";
        String str18_name="КАТЮША :";
        ...
        TextView explanation20=(TextView)rootView.findViewById(R.id.example20);
        final TextView translation20=(TextView)rootView.findViewById(R.id.translation20);

        String str20="ОФИЦЕР : Сто.";
        String trans20="100";
        String str20_name="ОФИЦЕР :";
        String str20_keyword1="Сто";
        String trans20_keyword1="100";
        //String str17_keyword2="Может быть";
        //String trans17_keyword2="Maybe";

        SpannableString spannableString20=new SpannableString(str20);
        SpannableString spannableString20_trans=new SpannableString(trans20);
        spannableString20.setSpan(new UnderlineSpan(),str20.indexOf(str20_keyword1),str20.indexOf(str20_keyword1)+str20_keyword1.length(),0);
        spannableString20_trans.setSpan(new UnderlineSpan(),trans20.indexOf(trans20_keyword1),trans20.indexOf(trans20_keyword1)+trans20_keyword1.length(),0);
        //spannableString17.setSpan(new UnderlineSpan(),str17.indexOf(str17_keyword2),str17.indexOf(str17_keyword2)+str17_keyword2.length(),0);
        //spannableString17_trans.setSpan(new UnderlineSpan(),trans17.indexOf(trans17_keyword2),trans17.indexOf(trans17_keyword2)+trans17_keyword2.length(),0);
        spannableString20.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.black)),str20.indexOf(str20_name),str20.indexOf(str20_name)+str20_name.length(),0);
        explanation20.setText(spannableString20);
        translation20.setText(spannableString20_trans);

        TextView explanation21=(TextView)rootView.findViewById(R.id.example21);
        final TextView translation21=(TextView)rootView.findViewById(R.id.translation21);

        String str21="КАТЮША : Это сто.";
        String trans21="Here's a hundred.";
        String str21_name="КАТЮША :";
        //String str18_keyword1="собака";
        //String trans18_keyword1="dog";
        SpannableString spannableString21=new SpannableString(str21);
        SpannableString spannableString21_trans=new SpannableString(trans21);
        //spannableString18.setSpan(new UnderlineSpan(),str18.indexOf(str18_keyword1),str18.indexOf(str18_keyword1)+str18_keyword1.length(),0);
        //spannableString18_trans.setSpan(new UnderlineSpan(),trans18.indexOf(trans18_keyword1),trans18.indexOf(trans18_keyword1)+trans18_keyword1.length(),0);
        spannableString21.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.black)),str21.indexOf(str21_name),str21.indexOf(str21_name)+str21_name.length(),0);
        explanation21.setText(spannableString21);
        translation21.setText(spannableString21_trans);

        TextView explanation22=(TextView)rootView.findViewById(R.id.example22);
        final TextView translation22=(TextView)rootView.findViewById(R.id.translation22);

        String str22="ОФИЦЕР : Спасибо. Твой самолёт там.";
        String trans22="Thank you. Your airplane is there.";
        String str22_name="ОФИЦЕР :";
        //String str22_keyword1="Сто";
        //String trans22_keyword1="100";
        //String str17_keyword2="Может быть";
        //String trans17_keyword2="Maybe";

        SpannableString spannableString22=new SpannableString(str22);
        SpannableString spannableString22_trans=new SpannableString(trans22);
        //spannableString22.setSpan(new UnderlineSpan(),str22.indexOf(str22_keyword1),str22.indexOf(str22_keyword1)+str22_keyword1.length(),0);
        //spannableString22_trans.setSpan(new UnderlineSpan(),trans22.indexOf(trans22_keyword1),trans22.indexOf(trans22_keyword1)+trans22_keyword1.length(),0);
        //spannableString17.setSpan(new UnderlineSpan(),str17.indexOf(str17_keyword2),str17.indexOf(str17_keyword2)+str17_keyword2.length(),0);
        //spannableString17_trans.setSpan(new UnderlineSpan(),trans17.indexOf(trans17_keyword2),trans17.indexOf(trans17_keyword2)+trans17_keyword2.length(),0);
        spannableString22.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.black)),str22.indexOf(str22_name),str22.indexOf(str22_name)+str22_name.length(),0);
        explanation22.setText(spannableString22);
        translation22.setText(spannableString22_trans);
        ...
        linearLayout20.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(translation20.getVisibility()==View.VISIBLE){
                    translation20.setVisibility(View.GONE);
                }
                else{
                    translation20.setVisibility(View.VISIBLE);
                }
            }
        });
        linearLayout21.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(translation21.getVisibility()==View.VISIBLE){
                    translation21.setVisibility(View.GONE);
                }
                else{
                    translation21.setVisibility(View.VISIBLE);
                }
            }
        });
        ...
        linearLayout22.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(translation22.getVisibility()==View.VISIBLE){
                    translation22.setVisibility(View.GONE);
                }
                else{
                    translation22.setVisibility(View.VISIBLE);
                }
            }
        });
        ...
        //final Uri uri19=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/question_words_fragment1");
        final Uri uri20=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/question_words_fragment1");
        final Uri uri21=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/question_words_fragment1");
        final Uri uri22=Uri.parse("android.resource://"+getContext().getPackageName()+"/raw/question_words_fragment1");
        ...
        linearLayout20.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View view) {
                /*mediaPlayer.stop();
                mediaPlayer.release();
        ...
        linearLayout21.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View view) {
                /*mediaPlayer.stop();
                mediaPlayer.release();
        ...
        linearLayout22.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View view) {
                /*mediaPlayer.stop();
                mediaPlayer.release();
